			...
			<ul class="nav" id="main-menu">
				...
				<li><a href="#"> <i class="fa fa-bolt fa-1x"></i>Questions<span
					...
					<ul class="nav nav-second-level">
						...
						<li><a href="GetQuestions"  class="active-menu"><i class="fa fa-edit fa-1x"></i>Edit
								Question </a></li>
...
<div class="se-pre-con"></div>
				...
				<%
					if (session.getAttribute("edit") != null
									&& "Success".equals(session.getAttribute("edit"))) {
				...
				<div class="alert alert-success fade in">
					...
					<strong>Success! </strong>Question successfully updated.
				</div>
				<%
					}
				%>
				<%
					if (session.getAttribute("edit") != null
									&& "Failed".equals(session.getAttribute("edit"))) {
								session.removeAttribute("edit");
				%>
				<button id='btn' style='display: none;'
					class="trigger error-trigger">Error</button>
				<div class="alert alert-danger fade in">
					<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
					<strong>Failed! </strong>Sorry the Question could not be updated.
				</div>
				<%
					}
				%>
				...
				<div class="alert alert-danger fade in">
					<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
					<strong>Sorry! </strong>There are no questions to be editted.
				</div>
				<%
					}
				%>
			<div class="panel panel-default">
					<div class="panel-heading">
						<i class="fa fa-edit fa-1x"></i> &nbsp; Edit Questions
					</div>
						<%
						try{
						...
						%>
					<form action='EditQuestion' method="post" name="deafultForm" id="defaultForm" class="form-horizontal">
							<div class="panel-body">
								<div class="form-group">
									<label class="col-lg-3 control-label"><span
										class="glyphicon glyphicon-tag"></span>Question</label>
									<div class="col-lg-8">
									<textarea class="form-control" name='question'><%=q.getQues()%></textarea>
								...
								<div class="form-group">
									...
									<div class="col-lg-5">
										<input type="text" class="form-control" name="option1" value='<%=q.getOption1()%>' />
									</div>
								</div>
								<div class="form-group">
									<label class="col-lg-3 control-label">Option 2</label>
									<div class="col-lg-5">
										<input type="text" class="form-control" name="option2" value='<%=q.getOption2()%>' />
									</div>
								</div>
								<div class="form-group">
									<label class="col-lg-3 control-label">Option 3</label>
									<div class="col-lg-5">
										<input type="text" class="form-control" name="option3" value='<%=q.getOption3()%>' />
									</div>
								</div>
								<div class="form-group">
									<label class="col-lg-3 control-label">Option 4</label>
									<div class="col-lg-5">
										<input type="text" class="form-control" name="option4" value='<%=q.getOption4()%>' />
									</div>
								</div>
								<div class="form-group">
